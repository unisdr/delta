		...
		<ViewComponent
			...
			extraActions={
				<ul>
					...
					<li><Link to={"/disaster-record/edit-sub/" + item.id + "/damages?sectorId=id1"}>Damages (Sector id1)</Link></li>
					<li><Link to={"/disaster-record/edit-sub/" + item.id + "/losses?sectorId=id1"}>Losses (Sector id1)</Link></li>
