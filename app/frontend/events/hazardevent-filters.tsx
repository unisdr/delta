...
export function HazardousEventFilters({
  ...
  // Filter hazards based on search term and selected cluster
  const filteredHazards = hip.hazards?.filter((hazard: any) => {
  ...
  const filteredClusters = hip.clusters?.filter((cluster: any) => {
