...
export default function Screen() {
	...
	return (
		<MainContainer title="Human Effects TODO">
			...
			<h5 style={{margin: "10px 0"}}>Male</h5>
			Total<input style={{width: "70px"}} type="text" />
			Age group 1 <input style={{width: "70px"}} type="text" />
			Age group 2 <input style={{width: "70px"}} type="text" />
			Age group 3 <input style={{width: "70px"}} type="text" />
			<h5 style={{margin: "10px 0"}}>Female</h5>
			Total<input style={{width: "70px"}} type="text" />
			Age group 1 <input style={{width: "70px"}} type="text" />
			Age group 2 <input style={{width: "70px"}} type="text" />
			Age group 3 <input style={{width: "70px"}} type="text" />
			<h5 style={{margin: "10px 0"}}>Total</h5>
			Total <input style={{width: "70px"}} type="text" />
			<h5 style={{margin: "10px 0"}}>Other disaggregations</h5>
			With disabilities <input style={{width: "70px"}} type="text" /><br />
			Below international poverty line <input style={{width: "70px"}} type="text" />
