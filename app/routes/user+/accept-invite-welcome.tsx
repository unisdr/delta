			...
			<div className="mg-container">
				<form className="dts-form dts-form--vertical">
					...
					<div className="dts-form__intro">
						<h1 className="dts-heading-1">Welcome to the Disaster tracking system.</h1>
						<p>Track disaster impacts, including damages, losses, and human effects, to support better recovery and resilience.</p>
					</div>

					<div className="dts-form__actions">
						<Link className="mg-button mg-button-primary" to={ `/user/accept-invite?inviteCode=${inviteCode}` }>Set up account</Link>
						...
						{loaderData.confAuthSupportedAzureSSOB2C && (
							<>
								<Link className="mg-button mg-button-outline" to={ `/sso/azure-b2c/invite?inviteCode=${inviteCode}&action=sso_azure_b2c-register` }>
									Set up using SSO</Link>
								<p>Note: For setup using SSO, please use the same email address where you received the invitation email.</p>
							</>
						)}
					</div>
